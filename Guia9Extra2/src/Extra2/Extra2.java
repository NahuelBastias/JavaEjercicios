/**
 * Juego Ahorcado: Crear una clase Ahorcado (como el juego), la cual deberá contener como atributos, un vector con la palabra a 
 * buscar, la cantidad de letras encontradas y la cantidad jugadas máximas que puede realizar el usuario. Definir los siguientes 
...
public class Extra2 {
    ...
    public static void main(String[] args) {
        ...
        AhorcadoService p1 = new AhorcadoService();
        p1.juego();
    }
